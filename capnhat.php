                    ...
                    <form class="form-access login-form js-login-form clearfix" action="xuly.php" method="POST" enctype="multipart/form-data">
                            <div id="left-col">
                                ...
                                <input type="text" class="form-control" id="inputPhoneEmailLogin" required
                                        placeholder="" name="tieude" value="<?php echo $row['tieude'] ?>"></div>
                                <div class="form-group form-group-password"><label for="password">Ảnh</label>
                                    <input type="hidden" name="size" value="1000000"> 
                                    <input type="hidden" name="idbaidang" value="<?php echo $row['id'] ?>"> 
                                    <input type="file" class="form-control" name="image"/>
                                </div>
                                <div class="form-group form-group-password"><label for="password">Số điện thoại</label><input
                                type="text" class="form-control" id="password" required placeholder="" value="<?php echo $row['sodienthoai'] ?>"
                                name="sodienthoai"></div>
                            </div>
                            <div id="aside">
                                <div class="form-group form-group-phone"><label for="inputPhoneEmailLogin">Giá thuê trên 1 tháng</label>
                                <input type="number" class="form-control" id="inputPhoneEmailLogin" required value="<?php echo $row['gia'] ?>"
                                ...
                                type="text" class="form-control" id="password" placeholder="" 
                                name="bando"></div>
                            </div>
                            <div class="form-group form-group-phone"><label for="inputPhoneEmailLogin">Địa chỉ phòng trọ</label>
                                <input type="text" class="form-control" id="inputPhoneEmailLogin" required value="<?php echo $row['diachi'] ?>"
                                        placeholder="" name="diachi"></div>
                            <div class="form-group form-group-phone"><label for="inputPhoneEmailLogin">Mô tả thông tin</label>
                            <textarea name="mota" class="form-control" id="editor" cols="30" tabindex="8" rows="30"><?php echo $row['mota'] ?></textarea>
                            </div>
                            <div class="form-group"><button type="submit" name="capnhat" class="btn btn-submit">Cập nhật</button></div>
                    </form>
                    </section>
                </div>
            </div>
